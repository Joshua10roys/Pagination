...
h1.innerText = 'Task Pagination'
div1.append(h1);

// creating <p> element
var p = document.createElement('p');
p.setAttribute('id', 'description');
p.innerText = 'Creating Pagination to set of data in each page'
div1.append(p);

// creating <div> <table> element
var div2 = document.createElement('div');
var table = document.createElement('table');
div2.setAttribute('class', 'table-responsive mx-5');
table.setAttribute('class', 'table table-bordered');
table.setAttribute('id', 'table');
body.append(div2);
div2.append(table);

// creating <div> element for pagination
var div3 = document.createElement('div');
div3.id = 'buttons';
div3.className = 'd-flex justify-content-center';
body.append(div3);

// pagination buttons
div3.innerHTML = `<nav aria-label="Page navigation example">
<ul class="pagination">
  <li><a onclick="display(0,10)" class="page-link text-black">First</a></li>
  ...
  <li><a onclick="display(90,100)" class="page-link text-black">Next</a></li>
</ul>
</nav>`
